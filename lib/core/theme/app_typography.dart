...
abstract class AppTypography {
  ...
  static TextStyle get bodyLarge =>
      _inter(fontSize: 17, height: 25, fontWeight: FontWeight.w500);

  static TextStyle get body =>
      _inter(fontSize: 16, height: 24, fontWeight: FontWeight.w400);

  static TextStyle get bodySmall =>
      _inter(fontSize: 14, height: 20, fontWeight: FontWeight.w400);

  static TextStyle get label =>
      _inter(fontSize: 14, height: 18, fontWeight: FontWeight.w600);
